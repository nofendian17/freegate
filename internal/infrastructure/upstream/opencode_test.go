...
u := NewOpenCodeUpstream(srv.URL, []string{"public"}, "", []string{"big-pickle"})
	u.client = NewHTTPClient(srv.URL, []string{"public"}, "", map[string]string{"x-opencode-client": "desktop"})
	return u
}
...
u := NewOpenCodeUpstream(srv.URL, []string{"public"}, "", allowlist)
	u.client = NewHTTPClient(srv.URL, []string{"public"}, "", map[string]string{"x-opencode-client": "desktop"})
	return u
}
